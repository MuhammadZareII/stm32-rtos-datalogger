...
/* ── Sensor limits ─────────────────────────────────────────────────────────── */
#define MAX_LM75        6   /* Max LM75 temperature sensors across all buses  */
#define MAX_ADXL345     4   /* Max ADXL345 accelerometers across all buses    */
#define MAX_I2C_BUSES   4   /* Number of physical I2C peripherals used        */

/* ── Sample rates (Hz) ─────────────────────────────────────────────────────── */
#define ADXL345_SAMPLE_HZ   100     /* Accelerometer — highest rate            */
#define LM75_SAMPLE_HZ       10     /* Temperature sensors                     */
#define SHT30_SAMPLE_HZ      10     /* Humidity sensor                         */
...
#define ADXL345_PERIOD_MS   (1000U / ADXL345_SAMPLE_HZ)
#define LM75_PERIOD_MS      (1000U / LM75_SAMPLE_HZ)
#define SHT30_PERIOD_MS     (1000U / SHT30_SAMPLE_HZ)
...
#define PKT_HEADER_1    0xBB
#define PKT_HEADER_2    0xCC
#define PKT_FOOTER_0    0xDD
#define PKT_FOOTER_1    0xEE
#define PKT_FOOTER_2    0xFF
#define PKT_MAX_BYTES   70      /* Maximum serialised packet size (bytes)      */

/* ── SD card raw-sector layout ─────────────────────────────────────────────── */
#define SD_SECTOR_META_0        101U  /* Sector counter backup copy 0           */
#define SD_SECTOR_META_1        103U  /* Sector counter backup copy 1           */
#define SD_SECTOR_META_2        104U  /* Sector counter backup copy 2           */
#define SD_SECTOR_FLIGHT_NUM    102U  /* Flight / session counter               */
#define SD_SECTOR_DATA_START    105U  /* First writable data sector             */
...
#define TASK_PRIO_ACCEL      6   /* ADXL345 — 100 Hz, tightest deadline        */
#define TASK_PRIO_GPS        5   /* GPS — time-critical for packet timestamps   */
#define TASK_PRIO_TEMP       4   /* LM75 + SHT30 — 10 Hz                       */
